...
def convnet(nclass):
    return ConvNet(nclass, net_norm='instance', net_depth=3, net_width=128, channel=3, net_act='relu', im_size=(32, 32)).cuda()

if __name__ == '__main__':
    # Initialize the network

    from torchsummary import summary
    net = ConvNet(10, net_norm='instance', net_depth=3, net_width=128, channel=3, net_act='relu', im_size=(32, 32)).cuda()
    ...
    # for index, name, module in enumerate(net.named_parameters()):
    #     print(index, name, module.shape)
    #     # if 'weight' in name[0]:
    #     # if hasattr(module, 'weight'):
    #     #     print(name)
    #     #     print(module)
    #     #     print("Pruning layer: ", name)
    #     #     pruning(model, name="wieight", amount=args.prune_ratio)
    #     #     # check_paras(model.state_dict()[name[0]])